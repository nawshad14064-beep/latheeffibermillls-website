      ...
      <div className="relative rounded-[3rem] md:rounded-[6rem] overflow-hidden h-[500px] md:h-[700px] shadow-3xl border-[8px] md:border-[16px] border-white group">
        ...
        <div className="absolute inset-0 p-8 md:p-24 flex flex-col justify-center text-white">
          ...
          >
            ...
            <h1 className="text-[4rem] md:text-[10rem] font-display text-white leading-[0.75] tracking-tighter uppercase">
              Sri Lankan <br />
              <span className="text-accent-amber italic">Coir Fiber Exporter</span>
            </h1>
            <p className="text-lg md:text-4xl text-white/90 font-serif italic leading-relaxed max-w-2xl">
              As a global leader in sustainable fiber, we are custodians of Sri Lanka's natural heritage and premium coir manufacturing.
            </p>
          </motion.div>
        </div>
      </div>
