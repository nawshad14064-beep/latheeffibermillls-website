...
export default function TrustStrip() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 -mt-12 relative z-40">
      <div className="bg-theme-card backdrop-blur-2xl rounded-full p-4 md:p-6 flex flex-wrap justify-center items-center gap-8 md:gap-16 border border-theme-card shadow-2xl">
        {items.map((item, i) => (
          <motion.div 
            key={i}
          ...
          >
            ...
            <span className="text-[9px] font-bold uppercase tracking-[0.4em] text-theme-muted group-hover:text-accent-gold transition-colors font-sans">
              {item.label}
            </span>
          </motion.div>
        ))}
