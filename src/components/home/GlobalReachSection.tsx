...
export default function GlobalReachSection() {
  return (
    <section className="py-20 md:py-48 bg-primary relative overflow-hidden px-6">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-center">
          <div className="relative order-2 lg:order-1 mt-12 lg:mt-0">
            <div className="aspect-square rounded-[3rem] md:rounded-[5rem] overflow-hidden shadow-3xl border-4 md:border-8 border-white/5">
              <img 
          ...
          <div className="space-y-12 md:space-y-16 lg:pl-12 order-1 lg:order-2">
            <div className="space-y-6 md:space-y-8">
              ...
              <h3 className="text-4xl md:text-8xl font-bold text-white font-serif leading-[1] md:leading-[0.9] tracking-tighter">Beyond <br /> <span className="text-accent-teal italic">Boundaries</span></h3>
            ...
            <div className="space-y-6 md:space-y-8">
              {[
                ...
                >
                  <div className="w-12 h-12 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-accent-teal shrink-0 group-hover:bg-accent-teal group-hover:text-white transition-all">
                    <item.icon className="w-6 h-6 md:w-7 md:h-7" />
                  </div>
                  <div>
                    <h4 className="text-lg md:text-xl font-bold text-white mb-1 md:mb-2">{item.title}</h4>
                    <p className="text-xs md:text-sm text-white/30 font-light">{item.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
